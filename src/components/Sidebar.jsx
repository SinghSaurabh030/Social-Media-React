export default function Sidebar({setSelectedTab}){
    ...
    return(
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sider" style={{width: "280px"}}>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item" >
        <a href="#" class="nav-link active" aria-current="page" name="Home" onClick={handleClick} >
          <svg class="bi pe-none me-2" width="16" height="16"><use xlinkHref="#home"></use></svg>
          Home
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white" name="CreatePost" onClick={handleClick}>
